...
These point to mirroring credentials in a BCI testing organisation. Please contact the
BCI team for expanding the configuration of that testing organisation.
...
BCI team for expanding the configuration of that testing organisation and please contact the SUSE Application
...
SUSE Linux Enterprise Server LTSS Regcodes can be obtained from the BCI testing organisation. Please contact the
BCI team for expanding the configuration of that testing organisation.
